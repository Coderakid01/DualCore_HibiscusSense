...
void FAVORIOT() {
    ...
    json += "\"Transceiver 2 Temperature\":\"" + String(incomingReadings.temp) + "\",";
    json += "\"Transceiver 2 Humidity\":\"" + String(incomingReadings.hum) + "\",";
    json += "\"Transceiver 2 Pressure\":\"" + String(incomingReadings.pres) + "\",";
    json += "\"Transceiver 2 Altitude\":\"" + String(incomingReadings.alt) + "\"";
