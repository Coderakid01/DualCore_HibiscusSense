...
void FAVORIOT() {
    ...
    json += "\"Transceiver 1 Temperature\":\"" + String(incomingReadings.temp) + "\",";
    json += "\"Transceiver 1 Humidity\":\"" + String(incomingReadings.hum) + "\",";
    json += "\"Transceiver 1 Pressure\":\"" + String(incomingReadings.pres) + "\",";
    json += "\"Transceiver 1 Altitude\":\"" + String(incomingReadings.alt) + "\"";
